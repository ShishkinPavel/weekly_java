...
public class ColoredPolygonTest {
    ...
    public void equalsSame() {
        ColoredPolygon coloredPolygon = new ColoredPolygon(polygon, Color.BLUE);
        ColoredPolygon coloredPolygon2 = new ColoredPolygon(polygon, Color.BLUE);
    ...
    public void hashesSame() {
        ColoredPolygon coloredPolygon = new ColoredPolygon(polygon, Color.BLUE);
        System.out.println(coloredPolygon.hashCode());
        System.out.println(new ColoredPolygon(polygon, Color.BLUE).hashCode());
